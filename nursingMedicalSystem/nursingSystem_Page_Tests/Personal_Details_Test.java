...
public class Personal_Details_Test extends BaseClass{
		...
		public void TC26() throws IOException {
			...
			try {
				...
				admisionDA.enterAge(PropertiesReader.getPropertyValue(CommonStaticDM.configPath, "AGE"));
				admisionDA.enterdateOfBirth(PropertiesReader.getPropertyValue(CommonStaticDM.configPath, "DOB"));
				//admisionDA.selectGenderOption(PropertiesReader.getPropertyValue(CommonStaticDM.configPath, "GENDER"));
				admisionDA.selectreligion(PropertiesReader.getPropertyValue(CommonStaticDM.configPath, "RELIGION"));
